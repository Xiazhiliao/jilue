...
const translates = {
	...
	jlsg_kuangfeng: "狂风",
	jlsg_kuangfeng_info: '准备阶段，你可以将一张"星"置入弃牌堆并选择一名角色，该角色获得一个"狂风"标记。当有此标记的角色受到伤害时，若此伤害：无属性，你摸X张牌；火焰伤害，此伤害+X；雷电伤害，你将牌堆顶的一张牌置入"星"(X为其"狂风"标记数）。',
	jlsg_dawu: "大雾",
	...
	jlsg_wumou: "无谋",
	jlsg_wumou_info: "锁定技，当你使用非延时锦囊牌时，你须选择一项：1，弃置一枚「暴」标记；2，受到一点无来源伤害；然后此牌不能被【无懈可击】响应",
	jlsg_wuqian: "无前",
	...
	jlsg_dianjie: "电界",
	jlsg_dianjie_info: "你可以跳过你的摸牌阶段或出牌阶段，然后判定，若结果为:黑桃，你对一名角色造成2点雷电伤害;若结果为梅花，你令任意名武将牌未横置的角色将其武将牌横置。",
	jlsg_shendao: "神道",
