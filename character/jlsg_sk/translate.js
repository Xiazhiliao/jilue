...
const translates = {
	...
	jlsg_huanbing: "缓兵",
	jlsg_huanbing2: "缓兵",
	jlsg_huanbing_info: "锁定技，当你成为【杀】的目标时，终止此【杀】的结算，改为将之置于你的武将牌上。准备阶段，你须为你武将牌上的每一张【杀】进行一次判定：若结果为红色，你摸一张牌；若结果为黑色，你须失去1点体力。然后将【杀】收入手牌。",
	jlsg_hongyuan: "弘援",
	...
	jlsgsk_duyu: "SK杜预",
	jlsg_sanchen: "三陈",
	jlsg_sanchen_info: "任意角色的回合开始阶段，你可以令其摸三张牌，然后其弃置三张牌，你获得以此法弃置的类别相同且数量最多的牌，若以此法弃置的牌类别各不相同，你可以令其摸三张牌。",
	jlsg_pozhu: "破竹",
	...
	*/
	...
	jlsgsk_shixie: "SK士燮",
	jlsg_biluan: "避乱",
	jlsg_biluan_info: "回合结束阶段，你可以弃置一张牌，若如此做，直到你的下个回合开始时，其他角色与你的距离+X，当你首次受到伤害后，你摸X张牌（X为存活角色数）。",
	jlsg_lixia: "礼下",
	jlsg_lixia_info: "其他角色的回合结束阶段，若你不在其攻击范围内，且该角色拥有你未获得过的技能，你可以将一个其他技能交给该角色，然后令其交给你一个你未获得过的技能。",
	jlsgsk_liuzan: "SK留赞",
	jlsg_fenyin: "奋音",
	...
	jlsg_falu: "法篆",
	jlsg_falu_info: "锁定技，游戏开始时，你获得三个已拥有且未上场的群势力储备技能。当你仅失去一张手牌后，记录此牌的颜色，然后若记录数为3，你移除所有记录，摸三张牌，再根据移除的颜色执行效果:均为黑色，对一名角色造成3点雷电伤害;均为红色，令一名角色获得你储备技能中的一个技能;否则你获得三个已拥有且未上场的群势力储备技能。",
	jlsg_zhenyi: "真仪",
