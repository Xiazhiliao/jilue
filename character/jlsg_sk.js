...
export default {
	...
	characterSort: {
		jlsg_sk: {
			...
			jlsg_jiangxing: ["jlsgsk_sunluyu", "jlsgsk_chengyu", "jlsgsk_mizhu", "jlsgsk_zhangren", "jlsgsk_zangba", "jlsgsk_hejin", "jlsgsk_zhangbao", "jlsgsk_bianfuren", "jlsgsk_heqi", "jlsgsk_tianfeng"],
	...
	character: {
		...
		jlsgsk_xianglang: ["male", "shu", 3, ["jlsg_cangshu", "jlsg_kanwu"], ["name:向|朗"]],
		jlsgsk_luji: ["male", "wu", 3, ["jlsg_huaiju", "jlsg_huntian"], ["name:陆|绩"]],
		jlsgsk_bianfuren: ["female", "wei", 3, ["jlsg_huage", "jlsg_muyi"], ["name:卞|null"]],
		jlsgsk_heqi: ["male", "wu", 4, ["jlsg_diezhang"], ["name:贺|齐"]],
		jlsgsk_mateng: ["male", "qun", 4, ["mashu", "jlsg_xiongyi"], ["name:马|腾"]],
		jlsgsk_tianfeng: ["male", "qun", 3, ["jlsg_sijian", "jlsg_gangzhi"], ["name:田|丰"]],
		jlsgsk_feiyi: ["male", "shu", 3, ["jlsg_yanxi", "jlsg_zhige"], ["name:费|祎"]],
		jlsgsk_jiangqin: ["male", "wu", 4, ["jlsg_shangyi", "jlsg_wangsi"], ["name:蒋|钦"]],
		jlsgsk_dongyun: ["male", "shu", 3, ["jlsg_bibu", "jlsg_kuangzheng"], ["name:董|允"]],
		jlsgsk_dongxi: ["male", "wu", 4, ["jlsg_duanlan"], ["name:董|袭"]],
		jlsgsk_quancong: ["male", "wu", 4, ["jlsg_yaoming"], ["name:全|琮"]],
		jlsgsk_yujin: ["male", "wei", 4, ["jlsg_zhengyi"], ["name:于|禁"]],
		jlsgsk_panfeng: ["male", "qun", 4, ["jlsg_kuangfu"], ["name:潘|凤"]],
		jlsgsk_dengzhi: ["male", "shu", 3, ["jlsg_hemeng", "jlsg_sujian"], ["name:邓|芝"]],
		jlsgsk_xuyou: ["male", "wei", 3, ["jlsg_yexi", "jlsg_kuangyan"], ["name:许|攸"]],
		jlsgsk_zhangbu: ["male", "wu", 3, ["jlsg_chaochen", "jlsg_quanzheng"], ["name:张|布"]],
		jlsgsk_miheng: ["male", "qun", 3, ["jlsg_shejian", "jlsg_kuangao"], ["name:祢|衡"]],
		jlsgsk_zumao: ["male", "wu", 4, ["jlsg_yinbing"], ["name:祖|茂"]],
		jlsgsk_huaxiong: ["male", "qun", 5, ["jlsg_fenwei", "jlsg_shiyong"], ["name:华|雄"]],
		jlsgsk_sunce: ["male", "wu", 4, ["jlsg_angyang", "jlsg_weifeng", "jlsg_xieli"], ["name:孙|策"]],
		jlsgsk_caoren: ["male", "wei", 4, ["jlsg_jushou"], ["name:曹|仁"]],
		jlsgsk_gongsunzan: ["male", "qun", 4, ["jlsg_yicong", "jlsg_muma"], ["name:公孙|瓒"]],
		jlsgsk_sunqian: ["male", "shu", 3, ["jlsg_suiji", "jlsg_fengyi"], ["name:孙|乾"]],
		jlsgsk_maliang: ["male", "shu", 3, ["jlsg_yalv", "jlsg_xiemu"], ["name:马|良"]],
		jlsgsk_buzhi: ["male", "wu", 3, ["jlsg_zhejie", "jlsg_fengya"], ["name:步|骘"]],
		jlsgsk_wangping: ["male", "shu", 4, ["jlsg_yijian", "jlsg_feijun"], ["name:王|平"]],
		jlsgsk_huangyueying: ["female", "shu", 3, ["jlsg_muniu", "jlsg_liuma"], ["name:黄|null"]],
		jlsgsk_dongzhuo: ["male", "qun", 6, ["jlsg_baozheng", "jlsg_lingnu"], ["name:董|卓"]],
		jlsgsk_chendao: ["male", "shu", 4, ["jlsg_zhongyong"], ["name:陈|到"]],
		jlsgsk_dingfeng: ["male", "wu", 4, ["jlsg_bozhan", "jlsg_qingxi"], ["name:丁|奉"]],

		jlsgsk_zhuran: ["male", "wu", 4, ["jlsg_danshou", "jlsg_yonglie"], ["name:朱|然"]],
		jlsgsk_lukang: ["male", "wu", 4, ["jlsg_hengshi", "jlsg_zhijiao"], ["name:陆|抗"]],
		jlsgsk_lvlingqi: ["female", "qun", 5, ["jlsg_jiwux", "zhuangrong"], ["name:吕|null"]],
		jlsgsk_zhoucang: ["male", "shu", 4, ["jlsg_daoshi"], ["name:周|仓"]],
		jlsgsk_kongrong: ["male", "qun", 3, ["jlsg_lirang", "jlsg_xianshi"], ["name:孔|融"]],
		jlsgsk_caochong: ["male", "wei", 3, ["jlsg_chengxiang", "jlsg_renxin"], ["unseen", "name:曹|冲"]],
		jlsgsk_zhanglu: ["male", "qun", 3, ["jlsg_midao", "jlsg_yishe", "jlsg_pudu"], ["name:张|鲁"]],
		jlsgsk_guanlu: ["male", "wei", 3, ["jlsg_zongqing", "jlsg_bugua"], ["name:管|辂"]],
		jlsgsk_simazhao: ["male", "wei", 3, ["jlsg_zhaoxin", "jlsg_zhihe"], ["name:司马|昭"]],
		jlsgsk_yangxiu: ["male", "wei", 3, ["jlsg_caijie", "jlsg_jilei"], ["name:杨|修"]],
		jlsgsk_liyan: ["male", "shu", 4, ["jlsg_yanliang"], ["name:李|严"]],
		jlsgsk_jiping: ["male", "qun", 3, ["jlsg_duzhi", "jlsg_lieyi"], ["name:吉|平"]],
		jlsgsk_sunhao: ["male", "wu", 4, ["jlsg_baoli"], ["name:孙|皓"]],
		jlsgsk_zhugejin: ["male", "wu", 3, ["jlsg_huanbing", "jlsg_hongyuan"], ["name:诸葛|瑾"]],
		jlsgsk_zhangxiu: ["male", "qun", 4, ["jlsg_huaqiang", "jlsg_chaohuang"], ["name:张|绣"]],
		jlsgsk_sunluyu: ["female", "wu", 3, ["jlsg_huilian", "jlsg_wenliang"], ["name:孙|鲁育"]],
		jlsgsk_luzhi: ["male", "qun", 3, ["jlsg_jinglun", "jlsg_ruzong"], ["name:卢|植"]],
		jlsgsk_yuji: ["male", "qun", 3, ["jlsg_guhuo", "jlsg_fulu"], ["name:于|吉"]],
		...
		jlsgsk_chengyu: ["male", "wei", 3, ["jlsg_pengri", "jlsg_danmou"], ["name:程|昱"]],
		jlsgsk_zhangren: ["male", "qun", 4, ["jlsg_fushe"], ["name:张|任"]],
		jlsgsk_mizhu: ["male", "shu", 3, ["jlsg_ziguo", "jlsg_shangdao"], ["name:糜|竺"]],
		jlsgsk_zangba: ["male", "wei", 4, ["jlsg_hengjiang"], ["name:臧|霸"]],
		jlsgsk_hejin: ["male", "qun", 4, ["jlsg_zhuanshan"], ["name:何|进"]],
		jlsgsk_wangyi: ["female", "wei", 3, ["jlsg_zhenlie", "jlsg_miji"], ["name:王|异"]],
		jlsgsk_zuoci: ["male", "qun", 3, ["jlsg_qianhuan"], ["name:左|慈"]],

		jlsgsk_guanyu: ["male", "wei", 4, ["jlsg_wusheng", "jlsg_danqi"], ["name:关|羽"]],
		jlsgsk_machao: ["male", "qun", 4, ["jlsg_zhuiji", "jlsg_xionglie"], ["name:马|超"]],
		jlsgsk_caiwenji: ["female", "wei", 3, ["jlsg_chenqing", "jlsg_mozhi"], ["name:蔡|琰"]],
		jlsgsk_zhangbao: ["male", "qun", 3, ["jlsg_zhoufu", "jlsg_yingbing"], ["name:张|宝"]],
		jlsgsk_guanxing: ["male", "shu", 4, ["jlsg_yongji", "jlsg_wuzhi"], ["name:关|兴"]],
		jlsgsk_kuaiyue: ["male", "qun", 3, ["jlsg_yidu", "jlsg_zhubao"], ["name:蒯越"]],
		jlsgsk_zhoutai: ["male", "wu", 4, ["jlsg_buqu", "jlsg_fenji"], ["name:周|泰"]],
		jlsgsk_zoushi: ["female", "qun", 3, ["jlsg_jiaomei", "jlsg_huoshui"], ["name:邹|null"]],
		jlsgsk_yanliang: ["male", "qun", 4, ["jlsg_hubu"], ["name:颜|良"]],
		jlsgsk_zhugeguo: ["female", "shu", 3, ["jlsg_yuhua", "jlsg_dengxian"], ["name:诸葛|null"]],
		jlsgsk_xizhicai: ["male", "wei", 3, ["jlsg_tiance", "jlsg_jiexin"], ["name:戏|志才"]],
		jlsgsk_guansuo: ["male", "shu", 4, ["jlsg_zhengnan", "jlsg_tongxin"], ["name:关|索"]],
		...
		jlsgsk_wuyi: ["male", "shu", 4, ["jlsg_zhidi"], ["name:吴|懿"]],
		jlsgsk_zhangliang: ["male", "qun", 4, ["jlsg_jijun", "jlsg_fangtong"], ["name:张|梁"]],
		jlsgsk_panshu: ["female", "wu", 3, ["jlsg_jinzhi", "jlsg_yuyou"], ["name:潘|淑"]],
		jlsgsk_caorui: ["male", "wei", 3, ["jlsg_huituo", "jlsg_xingshuai"], ["name:曹|叡"]],
		jlsgsk_liuchen: ["male", "shu", 4, ["jlsg_zhanjue"], ["name:刘|谌"]],
		jlsgsk_sunxiu: ["male", "wu", 3, ["jlsg_yanzhu", "jlsg_xingxue"], ["name:孙|休"]],
		jlsgsk_zhangrang: ["male", "qun", 3, ["jlsg_taoluan"], ["name:张|让"]],
		jlsgsk_xiahoushi: ["female", "shu", 3, ["jlsg_shiqiao", "jlsg_yingge"], ["name:夏侯|null"]],
		jlsgsk_sundeng: ["male", "wu", 3, ["jlsg_kuangbi"], ["name:孙|登"]],
		jlsgsk_caoxiu: ["male", "wei", 4, ["jlsg_taoxi"], ["name:曹|休"]],
		jlsgsk_caojie: ["female", "qun", 3, ["jlsg_huaibi", "jlsg_zhixi"], ["name:曹|节"]],
		jlsgsk_xinxianying: ["female", "wei", 3, ["jlsg_caijian", "jlsg_zhishix"], ["name:辛|null"]],
		jlsgsk_zhuzhi: ["male", "wu", 4, ["jlsg_anguo"], ["name:朱|治"]],
		jlsgsk_wanglang: ["male", "wei", 3, ["jlsg_quanxiang", "jlsg_gushe", "jlsg_jici"], ["name:王|朗"]],
		jlsgsk_wuxian: ["female", "shu", 3, ["jlsg_hechun", "jlsg_daiyan"], ["name:吴|null"]],
		jlsgsk_jushou: ["male", "qun", 3, ["jlsg_jianying", "jlsg_shibei"], ["name:沮|授"]],
		jlsgsk_sunliang: ["male", "wu", 3, ["jlsg_kuizhu", "jlsg_chezheng"], ["name:孙|亮"]],
		jlsgsk_wenyang: ["male", "wei", 7, ["jlsg_jueyong", "jlsg_choujue"], ["name:文|鸯"]],
		jlsgsk_yanyan: ["male", "shu", 4, ["jlsg_juzhan"], ["name:严|颜"]],
		jlsgsk_zhugezhan: ["male", "shu", 4, ["jlsg_zuilun", "jlsg_fuzhi"], ["name:诸葛|瞻"]],
		jlsgsk_panzhang: ["male", "wu", 4, ["jlsg_jiejun"], ["name:潘|璋"]],
		jlsgsk_sunru: ["female", "wu", 3, ["jlsg_xiecui", "jlsg_youxu"], ["name:孙|null"]],
		jlsgsk_liuyan: ["male", "qun", 3, ["jlsg_zhulu", "jlsg_limu"], ["name:刘|焉"]],
		...
		jlsgsk_chenqun: ["male", "wei", 3, ["jlsg_pindi", "jlsg_faen"], ["name:陈|群"]],
		jlsgsk_lvfan: ["male", "wu", 3, ["jlsg_diaodu", "jlsg_diancai"], ["name:吕|范"]],
		jlsgsk_hetaihou: ["female", "qun", 3, ["jlsg_zhendu", "jlsg_qiluan"], ["name:何|null"]],
		jlsgsk_zhangyi: ["male", "shu", 4, ["jlsg_wurong"], ["name:张|翼"]],
		jlsgsk_caochun: ["male", "wei", 4, ["jlsg_shanjia"], ["name:曹|纯"]],
		jlsgsk_shamoke: ["male", "shu", 4, ["jlsg_jili"], ["name:沙|摩柯"]],
		...
		jlsgsk_jiangwei: ["male", "wei", 5, ["jlsg_kunfen", "jlsg_caiyu"], ["name:姜|维"]],
		jlsgsk_huanghao: ["male", "shu", 3, ["jlsg_qinqing", "jlsg_huisheng"], ["name:黄|皓"]],
		jlsgsk_huaman: ["female", "shu", 3, ["jlsg_manyi", "jlsg_souying"], ["name:花|null"]],
		jlsgsk_pangtong: ["male", "wu", 3, ["jlsg_guolun", "jlsg_songsang"], ["name:庞|统"]],
		jlsgsk_lvdai: ["male", "wu", 4, ["jlsg_qinguo"], ["name:吕|岱"]],
	...
	skill: {
		...
		jlsg_quanzheng: {
			...
			filter: function (event, player) {
				...
				if (event.player.countCards("h") > player.countCards("h") || event.player.countCards("e") > player.countCards("e")) return get.type(event.card) == "trick" || event.card.name == "sha";
				return false;
			},
			frequent: true,
			content: function () {
		...
		jlsg_muma: {
			...
			filter: function (event, player) {
				...
				for (var i = 0; i < event.cards.length; i++) {
					if (event.cards[i].original == "e" && get.position(event.cards[i]) == "d") return !player.get("e", get.subtype(event.cards[i])[5]) && (get.subtype(event.cards[i]) == "equip3" || get.subtype(event.cards[i]) == "equip4");
				}
				return false;
			},
			content: function () {
				for (var i = 0; i < trigger.cards.length; i++) {
					if (trigger.cards[i].original == "e" && !player.get("e", get.subtype(trigger.cards[i])[5]) && (get.subtype(trigger.cards[i]) == "equip3" || get.subtype(trigger.cards[i]) == "equip4")) player.gain(trigger.cards[i], "gain");
				}
			},
		},
		jlsg_suiji: {
		...
		jlsg_midao: {
			...
			filter: function (event, player) {
				for (var i = 0; i < game.players.length; i++) if (game.players[i].num("h") > player.countCards("h")) return true;
				return false;
			},
			selectTarget: -1,
			multitarget: true,
		...
		jlsg_zhaoxin: {
			...
			filter: function (event, player) {
				...
				for (var i = 0; i < cards.length; i++) {
					if (suits.includes(get.suit(cards[i]))) suits.remove(get.suit(cards[i]));
				}
			...
			content: function () {
				...
				for (var i = 0; i < event.cards.length; i++) {
					if (suits.includes(get.suit(event.cards[i]))) suits.remove(get.suit(event.cards[i]));
				}
		...
		jlsg_zhihe: {
			...
			selectCard: function () {
				...
				var suits = [];
				for (var i = 0; i < cards.length; i++) {
					if (!suits.includes(get.suit(cards[i]))) suits.push(get.suit(cards[i]));
				}
				return suits.length;
			},
			content: function () {
		...
		jlsg_qianhuan: {
			...
			content: function () {
				...
				for (var i of list) {
					skills.addArray(
						(get.character(i)[3] || []).filter(function (skill) {
				...
				if (map && map.skills && map.skills.length) {
					let remove = player.storage.jlsg_qianhuan_fenpei.filter(s => player.hasSkill(s) && !map.skills.includes(s));
...
此阶段结束时受到来自${get.translation(player.storage.jlsg_fushe_source)}的1点伤害'`;
		...
		jlsg_jinzhi: {
			...
			enable: "chooseToUse",
			hiddenCard: function (player, name) {
				if (["basic", "trick"].includes(get.type(name)) && lib.inpile.includes(name) && player.countCards("h") && !player.getStorage("jlsg_jinzhi").includes(name) && player.getStorage("jlsg_jinzhi").length < 4) return true;
			},
			filter: function (event, player) {
		...
		jlsg_jiaozhao: {
			...
			filter: function (event, player) {
				...
				for (var i of lib.inpile) {
					var type = get.type(i);
					var card = { name: i };
					if (["basic", "trick"].includes(type) && game.hasPlayer(p => p != player && lib.filter.targetEnabled2(card, player, p))) return true;
				}
				return false;
			},
			chooseButton: {
		...
		jlsg_tiandao: {
			...
			content() {
				...
				if (cnt2 > 0) {
					let skills = jlsg.characterList
						...
						.filter(s => {
							...
							return skill && !skill.zhuSkill && !skill.limited && !skill.juexingji && !skill.hiddenSkill && !skill.charlotte && !skill.dutySkill;
						});
				...
				for (let t of game.filterPlayer()) {
					let value = -Math.min(t.countCards("he"), cnt1) * get.attitude(player, t) + get.damageEffect(t, player, player, "thunder") * cnt2;
					if (value > maxValue) {
						maxValue = value;
						target = t;
					}
		...
		jlsg_caiyu: {
			...
			async content(event, trigger, player) {
				...
				names.addArray(["jlsgsr_zhugeliang", "sp_zhugeliang", "jlsgsoul_zhugeliang", "jlsgsoul_sp_zhugeliang"]);
				let skills = [];
					...
					let { result } = await player
						.chooseCardTarget({
							...
							ai2: function (target) {
								...
								if (ui.selected.cards.some(c => c.name == "du") && !target.hasSkillTag("nodu")) return -20 * att;
				...
				record: {
					...
					filter(event, player, name) {
						...
						if (name == "useCardAfter") {
							if (player.storage.jlsg_ciwei_record?.some(evt => evt.card == event.card)) return true;
						}
						return true;
					},
					async content(event, trigger, player) {
				...
				used: {
					...
					intro: {
						content(storage) {
							let str = "本回合已因";
							let list = [];
							if (storage.includes("change")) list.add("变化");
							if (storage.includes("unchange")) list.add("不变");
