...
export function precontent(config) {
  ...
  game.import('character', jlsg_sk);//SK
  game.import('character', jlsg_skpf);// 皮肤武将
  game.import('character', jlsg_sr);// SR
  game.import('character', jlsg_soul);// Soul
  game.import('character', jlsg_sy);// 三英
  game.import('card', jlsg_qs);// 七杀
